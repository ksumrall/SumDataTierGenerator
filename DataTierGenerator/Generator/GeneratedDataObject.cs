...
namespace TotalSafety.DataTierGenerator.Generator
{
    ...
    class GeneratedDataObject : GeneratorBase {

        #region constructors / desturctors

        public GeneratedDataObject()
            : this( null ) {
        }

        public GeneratedDataObject( string rootNamespace )
            : this( rootNamespace, null ) {
        }

        public GeneratedDataObject( string rootNamespace, Table table )
        ...
        protected override void OnGetRegion_ConstructorsDestructors() {
            ...
            if( !string.IsNullOrEmpty( base.PK_PARAMETER_LIST ) ) {
                ...
                AppendLine( "#CONCRETE_GATEWAY_TYPE_NAME#.LoadByPrimaryKey(this, " + base.PK_ARGUMENT_LIST + ");" );
